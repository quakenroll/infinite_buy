...
for yy in range(0, 1):
	...
	outperform_rates_outperform_chart.append(outperformRate)

	outperform_orig_outperform_chart.append(originalAssetFinalVal)
	outperform_model_outperform_chart.append(portfolioFinalVal)
